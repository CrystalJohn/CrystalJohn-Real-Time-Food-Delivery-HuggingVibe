...
### Leader - Thanh Phúc (Front end 1) (Full-stack / Architect)
...
### Bá Thiên (Backend 1) (Order-processing – core)
...
### Tuấn Kha (Back end 2) (Ordering subscriber + status update)
...
### Leader - Thanh Phúc (Front end 1) (Front end 1)
...
### Tuấn Kha (Back end 2) (Delivery + Tracking – core)
- [ ] `delivery` module:
...
### Bá Thiên (Backend 1) (Ordering status from delivery events)
...
### Leader - Thanh Phúc (Front end 1) + Bá Thiên (Backend 1)
